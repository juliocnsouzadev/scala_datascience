...
object QueriesInFor {
  ...
  case class Baby(name: String, parents: List[String]);import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(663); 
  ...
  val babies = Set(
    ...
    Baby(
      name = "Solange",
      parents = List("Gilberto", "Maria")));System.out.println("""babies  : scala.collection.immutable.Set[week01.for_translationsjson.QueriesInFor.Baby] = """ + $show(babies ));$skip(71); val res$0 = 
